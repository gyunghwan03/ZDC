...
void fill_hist_HiForward_0001(int nevt=-1) 
{
	...
	gROOT->ForceStyle();
	TString fin = "./roots/HiForward_0001.root";
	TChain *evttree = new TChain("evttree");
	TChain *hlttree = new TChain("hlttree");
	TChain *skimtree = new TChain("skimtree");

	TFile *outFile = new TFile("./roots/hist_HiForward_0001.root","recreate");
	...
	int CoincFilter[5][9] = { {CoincFilterTh1, CoincFilterTh2, CoincFilterTh3, CoincFilterTh4, CoincFilterTh5, CoincFilterTh1p5, CoincFilterTh2p5, CoincFilterTh3p5, CoincFilterTh4p5},
		{CoincFilter2Th1, CoincFilter2Th2, CoincFilter2Th3, CoincFilter2Th4, CoincFilter2Th5, CoincFilter2Th1p5, CoincFilter2Th2p5, CoincFilter2Th3p5, CoincFilter2Th4p5},
		{CoincFilter3Th1, CoincFilter3Th2, CoincFilter3Th3, CoincFilter3Th4, CoincFilter3Th5, CoincFilter3Th1p5, CoincFilter3Th2p5, CoincFilter3Th3p5, CoincFilter3Th4p5},
		{CoincFilter4Th1, CoincFilter4Th2, CoincFilter4Th3, CoincFilter4Th4, CoincFilter4Th5, CoincFilter4Th1p5, CoincFilter4Th2p5, CoincFilter4Th3p5, CoincFilter4Th4p5},
		{CoincFilter5Th1, CoincFilter5Th2, CoincFilter5Th3, CoincFilter5Th4, CoincFilter5Th5, CoincFilter5Th1p5, CoincFilter5Th2p5, CoincFilter5Th3p5, CoincFilter5Th4p5}
	};
